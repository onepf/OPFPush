...
public final class OPFPushHelper {
    ...
    public void register() {
        OPFLog.methodD(OPFPushHelper.class, "register");
    ...
    public void unregister() {
        OPFLog.methodD(OPFPushHelper.class, "unregister");
        OPFChecks.checkInit(checkInit, true);
    ...
    void init(@NonNull final Configuration initialConfiguration) {
        OPFLog.methodD(OPFPushHelper.class, "init", initialConfiguration);
    ...
    void restartRegisterOnBoot() {
        OPFLog.methodD(OPFPushHelper.class, "restartRegisterOnBoot");
    ...
    void onNeedRetryRegister() {
        OPFLog.methodD(OPFPushHelper.class, "onNeedRetryRegister", currentProvider);
    ...
    void onProviderUnavailable(@NonNull final PushProvider provider) {
        OPFLog.methodD(OPFPushHelper.class, "onProviderUnavailable", provider);
    ...
    private void restoreLastProvider() {
        OPFLog.methodD(OPFPushHelper.class, "restoreLastProvider");
    ...
    private void registerFirstAvailableProvider() {
        OPFLog.methodD(OPFPushHelper.class, "registerFirstAvailableProvider");
        registerNextAvailableProvider(null);
    }

    private void registerNextAvailableProvider(@Nullable final String prevProviderName) {
        OPFLog.methodD(OPFPushHelper.class, "registerNextAvailableProvider", prevProviderName);
    ...
    private int getProviderPosition(@NonNull final List<PushProvider> providers,
        ...
        OPFLog.methodD(OPFPushHelper.class, "getProviderPosition", providers, providerName);
    ...
    private void register(@NonNull final PushProvider provider) {
        OPFLog.methodD(OPFPushHelper.class, "register", provider);
    ...
    private void unregister(@NonNull final PushProvider provider) {
        OPFLog.methodD(OPFPushHelper.class, "unregister", provider);
    ...
    private void unregisterPackageChangeReceiver() {
        OPFLog.methodD(OPFPushHelper.class, "unregisterPackageChangeReceiver");
    ...
    private PushProvider getProvider(@NonNull final String providerName) {
        OPFLog.methodD(OPFPushHelper.class, "getProvider", providerName);
    ...
    private PushProvider getProviderWithException(@NonNull final String providerName) {
        OPFLog.methodD(OPFPushHelper.class, "getProviderWithException", providerName);
    ...
    private PushProvider getLastProvider() {
        OPFLog.methodD(OPFPushHelper.class, "getLastProvider");
    ...
    private void initSortedProviderList() {
        OPFLog.methodD(OPFPushHelper.class, "initSortedProviderList");
    ...
    private void fakeOnUnregistered(@NonNull final String providerName,
        ...
        OPFLog.methodD(OPFPushHelper.class, "fakeOnUnregistered", providerName, registrationId);
        currentProvider = null;
        settings.clear();
    ...
    public final class ReceivedMessageHandler {
        ...
        public void onMessage(@NonNull final String providerName,
            ...
            OPFLog.methodD(ReceivedMessageHandler.class, "onMessage", providerName);
        ...
        public void onDeletedMessages(@NonNull final String providerName,
            ...
            OPFLog.methodD(ReceivedMessageHandler.class, "onDeletedMessages",
        ...
        public void onRegistered(@NonNull final String providerName,
            ...
            synchronized (registrationLock) {
                OPFLog.methodD(ReceivedMessageHandler.class, "onRegistered",
        ...
        public void onUnregistered(@NonNull final String providerName,
            ...
            synchronized (registrationLock) {
                OPFLog.methodD(ReceivedMessageHandler.class, "onUnregistered",
        ...
        public void onRegistrationError(@NonNull final String providerName,
            ...
            synchronized (registrationLock) {
                OPFLog.methodD(ReceivedMessageHandler.class, "onRegistrationError", providerName, error);
                if (!isRegistered()) {
        ...
        public void onUnregistrationError(@NonNull final String providerName,
                                          @NonNull final OPFError error) {
            synchronized (registrationLock) {
                OPFLog.methodD(ReceivedMessageHandler.class, "onUnregistrationError",
                        providerName, error);
        ...
        public void onError(@NonNull final String providerName, @NonNull final OPFError error) {
            synchronized (registrationLock) {
                OPFLog.methodD(ReceivedMessageHandler.class, "onError", providerName, error);
