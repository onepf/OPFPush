...
public abstract class OPFPushReceiver extends BroadcastReceiver implements EventListener {
    ...
    public final void onReceive(@NonNull final Context context, @NonNull final Intent intent) {
        OPFLog.methodD(OPFPushReceiver.class, "onReceive", context, OPFUtils.toString(intent));
    ...
    private void handleNoAvailableProvider(@NonNull final Context context,
        ...
        OPFLog.methodD(OPFPushReceiver.class, "handleNoAvailableProvider", context, OPFUtils.toString(intent));
    ...
    private void handleRegistrationAction(@NonNull final Context context,
                                          @NonNull final Intent intent) {
        OPFLog.methodD(OPFPushReceiver.class, "handleRegistrationAction", context, OPFUtils.toString(intent));
    ...
    private void handleUnregistrationAction(@NonNull final Context context,
                                            @NonNull final Intent intent) {
        OPFLog.methodD(OPFPushReceiver.class, "handleUnregistrationAction", context, OPFUtils.toString(intent));
    ...
    private void handleReceiveAction(@NonNull final Context context,
                                     @NonNull final Intent intent) {
        OPFLog.methodD(OPFPushReceiver.class, "handleReceiveAction", context, OPFUtils.toString(intent));
