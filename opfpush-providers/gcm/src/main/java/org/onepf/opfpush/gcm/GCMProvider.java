...
public class GCMProvider extends BasePushProvider implements SenderPushProvider {
    ...
    public synchronized void register() {
        OPFLog.methodD(GCMProvider.class, "register");
        executeTask(new RegisterTask());
    }

    public synchronized void unregister() {
        OPFLog.methodD(GCMProvider.class, "unregister");
        executeTask(new UnregisterTask(preferencesProvider.getRegistrationId()));
    }

    @Override
    public boolean checkManifest() {
        OPFLog.methodD(GCMProvider.class, "checkManifest");
    ...
    public boolean isRegistered() {
        OPFLog.methodD(GCMProvider.class, "isRegistered");
        return !TextUtils.isEmpty(preferencesProvider.getRegistrationId());
    }

    @Override
    public void onRegistrationInvalid() {
        OPFLog.methodD(GCMProvider.class, "onRegistrationInvalid");
        preferencesProvider.reset();
    }

    @Override
    public void onUnavailable() {
        OPFLog.methodD(GCMProvider.class, "onUnavailable");
        close();
    }

    @Override
    public void send(@NonNull final Message message) {
        OPFLog.methodD(GCMProvider.class, "send", message);
    ...
    private boolean checkGoogleAccount() {
        OPFLog.methodD(GCMProvider.class, "checkGoogleAccount");
    ...
    private void close() {
        OPFLog.methodD(GCMProvider.class, "close");
    ...
    private void executeTask(@NonNull final Runnable runnable) {
        OPFLog.methodD(GCMProvider.class, "executeTask", runnable);
    ...
    private final class RegisterTask implements Runnable {
        ...
        @Override
        public void run() {
            OPFLog.methodD(RegisterTask.class, "run");
        ...
        private void onServicesNotAvailable() {
            OPFLog.methodD(RegisterTask.class, "onServicesNotAvailable");
        ...
        private void onRegistrationSuccess(@NonNull final String registrationId) {
            OPFLog.methodD(RegisterTask.class, "onRegistrationSuccess", "registrationId");
        ...
        private void onAuthError() {
            OPFLog.methodD(RegisterTask.class, "onAuthError");
    ...
    private final class UnregisterTask implements Runnable {
        ...
        @Override
        public void run() {
            OPFLog.methodD(UnregisterTask.class, "run");
        ...
        private void onServicesNotAvailable() {
            OPFLog.methodD(UnregisterTask.class, "onServicesNotAvailable");
        ...
        private void onUnregistrationSuccess() {
            OPFLog.methodD(UnregisterTask.class, "onUnregistrationSuccess");
