...
public class DemoEventListener implements EventListener {
    ...
    public void onMessage(@NonNull final Context context,
        ...
        OPFLog.methodD(DemoEventListener.class, "onMessage", providerName, OPFUtils.toString(extras));
        if (extras == null) {
            return;
        }
    ...
    public void onDeletedMessages(@NonNull final Context context,
        ...
        OPFLog.methodD(DemoEventListener.class, "onDeletedMessages", providerName, messagesCount);
    }
    ...
    public void onRegistered(@NonNull final Context context,
        ...
        OPFLog.methodD(DemoEventListener.class, "onRegistered", providerName, registrationId);
    ...
    public void onUnregistered(@NonNull final Context context,
        ...
        OPFLog.methodD(DemoEventListener.class, "onUnregistered", providerName, registrationId);
    ...
    public void onNoAvailableProvider(@NonNull final Context context,
        ...
        OPFLog.methodD(DemoEventListener.class, "onNoAvailableProvider", context, registrationErrors);
